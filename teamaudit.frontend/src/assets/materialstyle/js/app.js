...
function(t) {
    ...
    function e(t, o) {
        var n;
        return n = t.hasClass("checkbox-inline") || t.hasClass("radio-inline") ? t : t.closest(".checkbox").length ? t.closest(".checkbox") : t.closest(".radio"),
    ...
    t.material = {
        ...
        attachInputEventHandlers: function() {
            ...
            t(document).on("keydown paste", ".form-control", function(n) {
                ...
                e ? n.removeClass("is-empty") : n.addClass("is-empty"),
                n.find("input.form-control[readonly]").val(e)
            })
        },
        ripples: function(o) {
...
function(t, o, n, e) {
    ...
    i.prototype.getRelX = function(t, o) {
        var n = t.offset();
        return s.isTouch() ? (o = o.originalEvent,
        1 === o.touches.length && o.touches[0].pageX - n.left) : o.pageX - n.left
    }
    ,
    i.prototype.getRelY = function(t, o) {
        var n = t.offset();
        return s.isTouch() ? (o = o.originalEvent,
        1 === o.touches.length && o.touches[0].pageY - n.top) : o.pageY - n.top
    }
    ,
