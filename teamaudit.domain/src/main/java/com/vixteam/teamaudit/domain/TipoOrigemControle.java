...
/**
 * Tipo Origem do Controle
 * 
 */
@Entity
@Table(name = "TPOCR")
public class TipoOrigemControle implements IEntity<String> {

    @Id
    @Column(name = "CD_TPOCR")
    ...
    @NotNull
    @Size(max = 100)
    @Column(name = "NM_TPOCR", length = 100, nullable = false)
    private String nome;

    @NotNull
    @Size(max = 255)
    @Column(name = "DS_TPOCR", nullable = false)
    private String descricao;

    @Convert(converter = SimNaoEnumConverter.class)
    @Column(name = "ID_TPOCR_INTR_SIST")
