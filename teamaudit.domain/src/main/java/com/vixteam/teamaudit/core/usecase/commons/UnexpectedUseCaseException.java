...
public class UnexpectedUseCaseException extends RuntimeException {
    ...
    public UnexpectedUseCaseException(String message, Throwable cause, boolean enableSuppression, boolean writableStackTrace) {
    ...
    public UnexpectedUseCaseException(Class<?> useCaseType, Throwable cause) {
        super("Erro ao executar caso de uso " + useCaseType.getSimpleName() + ": " + cause.getLocalizedMessage(), cause);
    }
